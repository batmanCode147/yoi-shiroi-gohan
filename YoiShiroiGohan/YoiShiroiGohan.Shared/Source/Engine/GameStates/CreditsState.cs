...
namespace YoiShiroiGohan
{
    class CreditsState : State
    {
        ...
        public CreditsState()
        {
            string creditsText = "OwlBeats: SFX and Sounds\nFinal Gate Studios: Music\nJalastram: SFX\nJdwasabi: SFX\nDan Knoflice: Lavaball Sprite\nTiny World: Font\nKaganawa: Game Design\nKaganawa: Sprite Assets\nKaganawa: Programming";
            ...
            menuTitle = new GameObject("Images\\title-template", new Vector2(152, 40), new Vector2(720, 170));

            credits = new TextLabel(creditsText, "Fonts\\PixelFont", new Vector2(220, 220), 0.8f, Color.White);

            bg_card = new GameObject("Images\\option_card", new Vector2(176, 190), new Vector2(671, 400));
        }
